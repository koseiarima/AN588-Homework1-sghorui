...
1.  At first, the at the start of this assignment, I was not able to connect R studio and GitHub together, due to some technical difficulties in mac. Then it worked when Chris did it manually. But it again showed error when I created a new project. So, deleted everything and reinstalled R from the beggining.

2.  I guess the problem was due to the directory error. I was saving the files in different places initially which might have been the issue. Once, I fixed it (saving all the files of AN 588 under a single folder), it seems to work smoothly since then; I was also able to commit.

3.  I am not able to get a hang of stringr package in challenge 1. Carly wrote me a code showing the steps, but I am still having some doubts. Will get it cleared from her next time

4.  Challenge 4 was a bit difficult, setting up the correct order was tricky.

5.  I was facing difficulties in figuring out where the index number for rows and columns would be assigned. Then I figured out that its first row and then column
